...
pub(crate) trait ImageBuilder {
    ...
    fn build(self) -> Result<Self::Image>;
}
...
impl SRecImageBuilder {
    pub fn new(regions: HashMap<String, MemorySection>, platform: Platform) -> Self {
        Self {
            current_locs: regions.clone(),
            regions,
            platform,
            codegen_tasks: vec![],
